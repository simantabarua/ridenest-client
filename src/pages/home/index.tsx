  ...
  const testimonials = [
    {
      ...
      role: 'Daily Commuter',
      rating: 5,
      content: 'RideShare has made my daily commute so much easier. The drivers are professional and the app is incredibly user-friendly.',
    ...
    },
    {
      ...
      rating: 5,
      content: 'I use RideShare for all my business trips. Reliable, clean cars, and always on time. Highly recommended!',
    ...
    },
    {
      ...
      role: 'Student',
      rating: 4,
      content: 'As a student, I appreciate the affordable pricing and safety features. It\'s my go-to transportation app.',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Experience safe, reliable, and affordable transportation at your fingertips. 
                Whether you're commuting to work or heading out for the night, we've got you covered.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We're committed to providing the best ride-sharing experience with features designed for your comfort and safety.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Getting a ride has never been easier. Follow these simple steps to reach your destination.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
